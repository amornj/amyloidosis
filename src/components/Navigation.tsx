...
const navItems = [
  ...
  { href: '/key-images', label: 'Key Images', icon: '🖼️' },
  ...
  const NavContent = () => (
    <>
      <div className="p-4 border-b border-white/20">
        <h1 className="text-xl font-bold text-white">Cardiac Amyloidosis</h1>
        <p className="text-xs text-blue-200 mt-1">Clinical Decision Pathway</p>
        <p className="text-[10px] text-blue-300/70 mt-1">2023 ACC Expert Consensus</p>
      </div>
